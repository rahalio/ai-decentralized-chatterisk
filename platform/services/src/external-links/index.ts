/**
 * ExternalLinks Services - Application Layer Export
 *
...
/**
 * ExternalLinks Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for external-links domain.
 */
